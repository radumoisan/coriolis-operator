...
- No dependencies, bootstrap Jobs, services, storage, secrets, or Coriolis runtime workloads have been implemented or deployed yet. The next step is resolving the retained-resource adoption authorization safety gate and the Secret/configuration/storage/readiness contracts before any MariaDB vertical slice.
