...
Milestone 11A logging hardening was published from source `f0c688bb835b7b80df6e9a803c3acaeda34bdc3b` by CIXpress Default `zom4hw` (CI release commit `6a22a270f312e2f2230829025b56a08e5bdf039f`, chart/app/operator `0.5.56`) against the unchanged frozen `2603.4` application ledger, and deployed isolated in `virt-infra-dev-buc-hq` namespace/Application `coriolis-m11a-20260908` (appliance `logging-hardening`, host `coriolis.app.cloudbase.wiki`) at observed operator digest `sha256:91e0566b80dcfbdfbaa61607adbc00c3a742fd49fe7abab51f2e9e3412e77d40` with 19 zero-restart Pods. Live observation produced one image-behavior finding: the immutable `coriolis-conductor:2603.4` image (`sha256:27495f44fbb8b320098d0aa04cd9dcb2a4b432e57aa17417606efc5403ac09c7`) declares its `temp_keypair_password` oslo option without `secret=True`, so under `debug=true` the credential value reaches conductor stdout/stderr and then Pod logs (proven value-silently; no value, hash, or encoded form recorded), which drove the user-selected `coriolisDebug` safe-default change to false. Corrective publication, released-validator rerun, and formal retention qualification remain pending; this is not acceptance or closure of Milestone 11A or broader Milestone 11 and does not change the frozen digest tables above.
