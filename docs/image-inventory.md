...
- The inventory and pull gate are **complete**, but runtime integration remains blocked by the sensitive-renderer implementation and multi-resource semantics gates; no Coriolis core runtime workloads have been implemented or deployed yet.
