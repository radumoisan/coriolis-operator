...
- The inventory and pull gate are **complete**, but runtime integration remains blocked by the multi-resource read/apply failure, reconciliation-status, atomicity, and marker-last semantics gate; no Coriolis core runtime workloads have been implemented or deployed yet.
