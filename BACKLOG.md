...
- CSI and cross-node attach/detach evidence remain open beyond the accepted single-node POC. Production backup/restore, HA, and RPO/RTO acceptance remain separate gates. Argo has removed the legacy Deployment selector overlap and currently runs healthy `0.5.8`.
