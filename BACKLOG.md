...
- Cleanup removed owned resources in 20s, the namespace in 78s, and final Rabbit/Maria Delete-policy PVs in 1s. CSI/cross-node attach-detach, backup/restore, HA, RPO/RTO, credential rotation, and production storage remain open. Keystone runtime evidence is next.
